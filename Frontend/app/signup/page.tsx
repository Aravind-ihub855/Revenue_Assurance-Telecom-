      ...
      <div className="w-full max-w-md bg-white dark:bg-gray-900 rounded-3xl shadow-xl border border-gray-100 dark:border-gray-800 p-8 relative z-10 transition-all">
        ...
        <form onSubmit={handleSignup} className="space-y-5">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-primary-600 hover:bg-primary-500 text-white font-semibold py-3.5 px-4 rounded-xl transition-all flex items-center justify-center shadow-lg shadow-primary-500/20 disabled:opacity-70 active:scale-[0.98] mt-2"
          >
        ...
        <p className="text-center text-sm text-gray-500 dark:text-gray-400 mt-8">
          Already have access?{' '}
          <Link href="/login" className="text-primary-600 hover:text-primary-400 font-semibold transition-colors">Sign In</Link>
        </p>
      </div>
    </div>
  );
